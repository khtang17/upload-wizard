...
Revision ID: b9ef37fcc971
Revises: 
Create Date: 2019-07-12 23:57:06.015880
...
def upgrade():
    ...
    sa.Column('cmpdname', sa.String(length=100), nullable=True),
    sa.Column('cas', sa.String(length=100), nullable=True),
    sa.Column('price', sa.String(length=20), nullable=True),
    sa.Column('job_notify_email', sa.Boolean(), nullable=True),
